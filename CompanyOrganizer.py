        ...
        #Control an Employee:
          ...
          while True:
            ...
            try:
              ...
              print("""Introduce:
                    'work' if you want him to work 
                    'rest' if you want him to rest
                    'break' if you want to stop controlling:""")
              while True:
                activity = input()
                if activity.lower() == "work":
...
while True:  
  ...
  try:
    ...
    break
while True:  
  BossHoursOfWork = input("Introduce the hours that you work:")
  try:
